...
class _CartPageState extends State<CartPage> {
  ...
  void addOrder(HomePageController controller, BuildContext context) async {
    ...
    if (controller.cartItems.isEmpty) {
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          const SnackBar(
            content: Text("No items in cart yet"),
          ),
        );
    } else {
